...
function SolarDataForm({
  ...
  function handleCheckBoxChange(event) {
    ...
    if (!isChecked) onFormChange({ ...formState, endDate: "" });
  }
        ...
        <div>
          <InputField
            ...
            onChange={(e) =>
              onFormChange({
                ...formState,
                city: capitalizeFirstChar(e.target.value),
              })
            }
            required
          />
          <InputField
            ...
            onChange={(e) =>
              onFormChange({ ...formState, country: e.target.value })
            }
            required
          />
          ...
          <div className="mb-4 max-w-lg flex flex-col">
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="useRange" className="flex gap-2">
                {" "}
                Use range{" "}
              </label>
            </div>
            {useEndDate ? (
              <>
                ...
                <InputField
                  ...
                  onChange={(e) =>
                    onFormChange({ ...formState, endDate: e.target.value })
                  }
                />
              </>
            ) : (
